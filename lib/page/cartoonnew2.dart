...
import 'package:dektoonapp/page/CartoonEP/Cartoon2EP1.dart';
...
class Cartoonnew2 extends StatelessWidget {
  @override
...
class Ctnew2 extends StatefulWidget {
  @override
  _Cartoonnew2State createState() => _Cartoonnew2State();
}

class _Cartoonnew2State extends State<Ctnew2> {
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => CTID2EP1()));
                    },
                  ),
                ],
              ),
